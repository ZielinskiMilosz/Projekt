<html>
    ...
    <?php
        ...
        if($_SESSION["email"])
        {
            echo '<div class="box1"><h1>Wypożyczalnia Filmów</h1> Zalogowany Jako: '.$_SESSION["email"].'<br>';
        ...
        {
            echo '<div class="box1"><h1>Wypożyczalnia Filmów</h1>';
            echo '<div class="panel">
        ...
        for($i = 0; $i<count($cos22);$i++)
        {
            if($cos22[$i][4]==1)
            {
            echo '<div class="box"><div class="left">Nazwa: '.$cos22[$i][1].'<br>Typ: '.$cos22[$i][3].'<br> Opis: '.$cos22[$i][2].'<br></div><div class="right">foto</div><div class="leftd">';
